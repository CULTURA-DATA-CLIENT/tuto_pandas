...
- Pour vérifier l'installation depython, ouvrez un terminal et tapez : 

```
    Python --version
```

- cette commande devrait vos retourné quelque chose du genre : 
```
    python 3.11.3
```
...
2. Naviguez jusqu'au dossier `traffic` du projet.
